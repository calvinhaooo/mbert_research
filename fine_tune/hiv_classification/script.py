...
cls_args = ClassificationArgs(num_train_epochs=1,
...
for fold in range(10):
    ...
    model_args.output_dir = f"outputs/fixed_1/medroberta-erasmus/fold_{fold}/"
    ...
    val = pd.read_csv(f'dataset/cv_splits/fold_{fold}_val.csv')
